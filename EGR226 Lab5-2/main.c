...
* Project:           Lab 05 Part 2 - Digital Inputs and Outputs – Interfacing External Switches and LEDs to the MSP432
* File:              main.c
...
void main(void)
{
    ...
    while(1) {
        ...
        case 2:
            ...
            if (checkButtonPress() == 1) {      //Check for button being held down
